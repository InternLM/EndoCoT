...
def render_sudoku(grid, out_path, puzzle_mask=None, size_px=512):
    ...
    try:
        font = ImageFont.truetype("/mnt/shared-storage-user/mllmexp/daixuanlang/code/DiffThinker_baseline/DiffThinker-main/Sudoku/思源黑体SourceHanSansCN-Light.otf", int(cell_size * 0.6))
        assert False
    except:
    ...
    for i in range(9):
        for j in range(9):
            ...
            if val != 0:
                ...
                color = "black" if (puzzle_mask is None or is_fixed) else "#1A73E8"
