...
def process_single_directory(root_dir, is_final):
    ...
    prefix_prompt = "Draw a continuous red line starting from the yellow dot towards the blue dot step-by-step, avoiding all walls. Mark the current end of the path with a green dot. Direction keys: D=Down, U=Up, R=Right, L=Left."
