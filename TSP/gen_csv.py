...
def process_single_directory(root_dir, is_final):
    ...
    prefix_prompt = "Draw a continuous red line step-by-step from the start point to form the shortest closed loop, marking the current endpoint with a green dot."
