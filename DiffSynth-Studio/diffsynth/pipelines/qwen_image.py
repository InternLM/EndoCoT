...
class QwenImagePipeline(BasePipeline):
    ...
    def from_pretrained(
        ...
        hidden_size = pipe.text_encoder.model.config.hidden_size
        pipe.mlp = nn.Sequential(
    ...
    def __call__(
        ...
        for progress_id, timestep in enumerate(progress_bar_cmd(self.scheduler.timesteps)):
            ...
            if return_intermediates:
                ...
                pred_original_sample = inputs_shared["latents"] - t * noise_pred
                
                self.load_models_to_device(['vae'])
                image_x0 = self.vae.decode(pred_original_sample, device=self.device)
                image_x0 = self.vae_output_to_image(image_x0)
                predicted_x0_images.append(image_x0)
        # Decode
        self.load_models_to_device(['vae'])
        ...
        if return_intermediates:
            return image, predicted_x0_images
...
class QwenImageUnit_PromptEmbedder(PipelineUnit):
    def __init__(self):
        ...
        super().__init__(
            ...
            input_params_nega={"prompt": "negative_prompt", "is_final": "is_final", "gt_prompt": "gt_prompt", "idx": "idx"},
            # input_params_nega={"prompt": "negative_prompt", "is_final": "is_final"},
        ...
        if pipe.text_encoder is not None:
            ...
            if edit_image is None:
                ...
                try:
                    ...
                    split_hidden_states = self.encode_prompt_edit(pipe, prompt, edit_image, is_final, gt_prompt, idx)
            else:
            ...
            try:
                return {"prompt_emb": prompt_embeds, "prompt_emb_mask": encoder_attention_mask, "prompt": new_prompt, "eos_loss": eos_loss}
            except:
