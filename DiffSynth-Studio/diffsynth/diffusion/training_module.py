...
class DiffusionTrainingModule(torch.nn.Module):
    ...
    def switch_pipe_to_training_mode(
        ...
        lora_base_models = lora_base_model.split(",")
        lora_target_modules_list = lora_target_modules.split(";")
        for lora_base_model, lora_target_modules in zip(lora_base_models, lora_target_modules_list):
