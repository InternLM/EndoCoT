NAME="FrozenLake" #Maze,Sudoku,TSP,FrozenLake,Edit
...
Output_Path="/path/to/the/${NAME}/save/dir/${NAME}_stage2" 
...
accelerate launch --config_file examples/qwen_image/model_training/full/accelerate_config.yaml examples/qwen_image/model_training/train.py \
  ...
  --dataset_metadata_path "${Data_Path}/metadata_edit_final.csv" \
